...
class Particle3D(object):
    ...
    def __init__(self, label, mass, pos, vel):
        ...
        self.position = np.array(pos, float) #Changing position vector into array float using numpy array
        self.velocity = np.array(vel, float) #Changing velocity vector into array float using numpy array
    ...
    def __str__(self):
        ...
        """
        return str(self.label) + ", pos = " + str(self.position) + ", v = " + str(self.velocity) + ", m = " + str(self.mass)
    ...
    def momentum(self):
        ...
        return np.multiply(self.velocity, self.mass)
    ...
    def update_pos(self, dt):
        ...
        """
        self.position += np.multiply(self.velocity, float(dt))
    ...
    def update_pos_2nd(self, dt, f):
        ...
        :return pos: Updated position for Particle3D instance
        """
        self.position += (self.velocity * float(dt)) + ((f/(2 * self.mass)) * float(dt)**2)
    ...
    def update_vel(self, dt, f):
        ...
        """
        self.velocity += (f/self.mass) * float(dt)
